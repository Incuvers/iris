...
# from monitor.models.icb import ICB
# from tests.resources import icb
...
#         Test string repr
#         """
#         self.icb.deserialize(**icb.ICB_SENSORFRAME)
...
#         self.icb.deserialize(**icb.ICB_SENSORFRAME)
#         self.maxDiff = None
#         self.assertDictEqual(self.icb.serialize(), icb.ICB_SENSORFRAME_2_CONV)
...
#         self.icb.deserialize(**icb.ICB_SENSORFRAME_2)
